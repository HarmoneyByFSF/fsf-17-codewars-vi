  ...
  return <div className="scrollable-container">
    <div>
      <div style={{ display: 'flex', flexDirection: 'row', gap: '20px' }}>
        <div class="savinggoal-container" style={{ boxShadow: "0px 8px 25px rgba(208, 210, 218, 0.9)" }}>
          <img src={dinner} class="savinggoal-image" alt="" />
          <div class="savinggoal-title">
            Family Dinner
          </div>

          <div class="savinggoal-date">
            4 September 2023
          </div>

          <div class="savinggoal-price">
            Rs 450.0
          </div>
      ...
      <p style={{ fontSize: "20px", fontWeight: "400", color: "black" }}>Tip</p>

      <div class="rowd">
        <div class="tipstext">
          <span>Have a clear picture of the regular expenses <br></br> and spending habits.<br></br>
            This helps you see where you can <br></br>
            cut back and save.</span>
        </div>
        <div class="addbutton">
