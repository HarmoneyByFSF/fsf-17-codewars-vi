    ...
    <div className="scrollable-container">
      ...
      <div style={{ display: "flex" , flexDirection : "row"}}>
        <div style={{ paddingBottom: "20px" }}>
          <div class="learnmore-container" style={{ height: "270px",backgroundColor: "#F985AF" }}>
            <div class="learnmore-price">
              Free
            </div>

            <img className="learnmore-image" src={insurance} alt="Expense Image" />

            <div class="learnmore-title">
              What is
            </div>
        ...
        <div style={{ paddingBottom: "20px" }}>
          <div class="learnmore-container" style={{ height: "270px" ,backgroundColor: "#F5F2FF" }}>
            <div class="learnmore-price">
              25 tokens
            </div>

            <img className="learnmore-image" src={investing} alt="Expense Image" />
      ...
      <div>
        <div class="container">
          <img className="expense-image" style={{ height: "60px", width: "60px" }} src={video} alt="Expense Image" onClick={() => openPopup('https://youtu.be/SS-0dXz98Xo')} />
